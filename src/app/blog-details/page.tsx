...
const BlogDetailsPage = () => {
  ...
  <Image
    ...
    alt="author"
    fill
    sizes="(max-width: 640px) 50vw, 100px"  // Adjust based on your layout requirements
  />
</div>
  ...
  <Image
    ...
    sizes="(max-width: 640px) 100vw, (max-width: 768px) 50vw, 33vw" // Add sizes for better performance
  />
</div>
