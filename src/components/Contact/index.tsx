          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              ...
              <p className="mb-12 text-base font-medium text-body-color">
                تواصل معنا للحصول على استشارة قانونية متخصصة، وسيقوم فريقنا القانوني بالرد عليك في أقرب وقت ممكن عبر البريد الإلكتروني.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="يرجى إدخال تفاصيل استفسارك القانوني"
