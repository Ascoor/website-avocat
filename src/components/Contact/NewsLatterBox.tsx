...
const NewsLatterBox = () => {
  ...
  useEffect(() => {
    // تحديث القيمة فقط في العميل
    setCurrentTheme(theme);
  }, [theme]);

  // إرجاع null حتى يتم تحديث الـ theme على العميل
  if (currentTheme === undefined) {
    return null; // يمكن استبدالها بمؤشر تحميل (loading spinner) إذا رغبت
  }
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={currentTheme === "light" ? "#4A6CF7" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
