...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (
      // أيقونة تحرير العقود (ورقة وقلم)
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path opacity="0.5" d="M5 10H35V35H5V10Z" />
        <path d="M10 5H30V10H10V5Z" />
        <path d="M15 20H25V22H15V20Z" />
        <path d="M15 25H30V27H15V25Z" />
        <path d="M15 30H22V32H15V30Z" />
      </svg>
    ),
    title: "تحرير العقود",
    paragraph:
      "إعداد وصياغة العقود القانونية بأنواعها لضمان حماية حقوق الأطراف والتوافق مع القوانين المعمول بها.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "تقديم استشارات قانونية متخصصة للأفراد والشركات لضمان اتخاذ القرارات الصحيحة وحماية المصالح القانونية.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "الإستعلام عن المستندات والأشخاص",
    paragraph:
      "توفير خدمات الاستعلام القانوني عن المستندات الرسمية والأشخاص وفقًا للإجراءات القانونية المعتمدة.",
  },
  {
    id: 4,
    icon: (
    ...
    title: "إقامة الدعاوي القانونية",
    paragraph:
      "إعداد ورفع القضايا والدفاع عن العملاء أمام المحاكم بكافة أنواعها لضمان تحقيق العدالة وحماية الحقوق.",
  },
  {
    id: 5,
    icon: (
    ...
    title: "الخدمات الإلكترونية عن بعد",
    paragraph:
      "تقديم خدمات قانونية إلكترونية عن بُعد، بما في ذلك الاستشارات القانونية، تحرير العقود، ومتابعة القضايا عبر الإنترنت.",
  },
  {
    id: 6, 
      icon: (
    ...
    title: "خدمات قانونية أخرى",
    paragraph:
      "نقدم مجموعة واسعة من الخدمات القانونية، مثل التوثيق، الوساطة، التحكيم، والتفاوض على التسويات القانونية.",
  },
];
